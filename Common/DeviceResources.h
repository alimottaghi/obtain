...
//===================================================================//
// This section handles the initialization of the graphics subsystem
//   including Direct2D (used for 2D drawing operations),
//   DirectWrite (used for flexible text rendering) and DXGI
//   (DirectX Graphical Infrastructure)
//===================================================================//
